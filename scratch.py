...
if __name__ == "__main__":
    ...
    ssim.advance(orbits=0.25, spawns=40, orbits_reference="Europa", verbose=True)
    ...
    sa.plot_planar(
        timestep=39, d=3, scatter=True, triplot=False, show=True, trialpha=.6, lim=15,
